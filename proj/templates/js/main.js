...
function createDownloadLink(blob) {
    ...
    d.appendChild(document.createTextNode (" "))//add a space in between
    ...
    //recordingsList.replaceChild(li,mynode.firstChild);
...
function myCallBack(xhr){
    ...
    if (xhr.readyState==4 && xhr.status==200) {
        ...
        var ele2=document.getElementById("sw");
        var word=xhr.responseText;
        ...
        btn.type = "submit";
        btn.name = "formBtn";
        btn.href="http://127.0.0.1:5000/video"
        ...
        btn1.type = "submit";
        btn1.name = "formBtn";
        btn1.href="http://127.0.0.1:5000/clinics"
